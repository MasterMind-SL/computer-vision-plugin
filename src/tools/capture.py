...
def cv_screenshot_window(hwnd: int, max_width: int = 1280) -> dict:
    ...
    Returns a base64-encoded PNG image scaled to max_width, plus window
    geometry and DPI metadata.
...
def cv_screenshot_desktop(max_width: int = 1920) -> dict:
    ...
    Returns a base64-encoded PNG image scaled to max_width, plus desktop
    geometry metadata.
